...
| Consented staging recipient and approved suppression exercise | Resend launch evidence | Awaiting one recipient who has consented to the controlled bilingual message and suppression test. Codex can dispatch and reconcile the existing purpose-bound workflow after that fact exists; do not suppress the owner address merely to make the gate green |
| Dust Wave YouTube OAuth/channel session and inspection | Controlled unlisted YouTube evidence | Awaiting provider authentication/2FA and inspection of one revision-bound unlisted result on the configured Dust Wave channel. The upload, idempotency, ambiguity, reconciliation, public-timing, and premium-bonus exclusion contracts are already automated |
| Directory provider logins, terms, ownership codes, and reviews | 10+ platform certification | Awaiting the provider-controlled steps for at least ten enabled destinations. The credential-free packet, feed/artwork/enclosure validation, observation polling, recovery evidence, and 10+ claim gate are already automated; never fabricate setup or ingestion evidence |
