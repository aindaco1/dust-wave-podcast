...
| Durable Google consent configuration | Maintaining YouTube access beyond the renewed Testing grant | Exact-channel access was restored September 7. External / Testing grants for these scopes last seven days, so renewal is expected again around September 14 unless this is resolved. Review the shared Film project and its Film Web client before approving a project-wide consent publishing/verification change; see current state |
